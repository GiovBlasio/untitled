...
class WebViewGoogleFacebookState extends State<WebViewGoogleFacebook> {
  ...
  final COGNITO_CLIENT_ID = '4qo0glacl4kpvdpnf0825k8mtf';
  final COGNITO_Pool_ID = 'us-east-1_uBOx8VaIw';
  final COGNITO_POOL_URL = 'ingsw.auth.us-east-1';  // CHANGE YOUR DOMAIN NAME
  final CLIENT_SECRET = '1s832trnmis1tgvakblnklpb26emd16qhmdo5rkpuuk04u0m2q7n';
